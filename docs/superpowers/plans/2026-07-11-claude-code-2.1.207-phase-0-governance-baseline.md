...
- The post-integration regression is clone-portable: it accepts Sub2API only through explicit `SUB2API_ROOT`, clones clean `main` sources into temporary fixtures, and creates the historical governance branches at reviewed commits `a54a44d107164d11428da06cc3eea979f488d350` (CC Gateway) and `d596bb461b1cbb4f0ca8b299333f621ed8d4fd4f` (Sub2API). It must not depend on a sibling checkout or pre-existing local feature refs.
