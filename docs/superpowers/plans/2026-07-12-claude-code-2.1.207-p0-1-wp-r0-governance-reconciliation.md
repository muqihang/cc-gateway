...
- Create: `docs/superpowers/schemas/oracle-lab-governance-amendment-command-results.schema.json`
...
- Create: `tools/oracle-lab/ignored-path-inventory.ts`
...
- Create: `tests/oracle-lab-ignored-path-inventory.test.ts`
