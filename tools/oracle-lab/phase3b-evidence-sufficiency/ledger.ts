...
export const BOOTSTRAP_CONTRACT_SCHEMA = deepFreeze({ schema_id: 'oracle-lab-p3b-bootstrap-contract.v2' as const, winner_source: ['direct', 'user', 'project', 'local'] as const, selected_route_ordinal: [0, 1] as const, bootstrap_source: [null, 'direct', 'user', 'process-env'] as const, expected_count: [0, 1] as const, expected_route_ordinal: [null, 0, 1] as const, derivation: 'sealed-staged-source-precedence-v2' as const })
