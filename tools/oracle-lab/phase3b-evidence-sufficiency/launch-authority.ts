...
export function assertControllerLaunchPrerequisites(controller: ProductionController): void {
  ...
  for (const field of ['cc_repository', 'sub_repository', 'implementation_review_path', 'cross_repo_review_path', 'platform_archive_path', 'source_tree_path', 'toolchain_path', 'schema_bundle_path', 'focused_suite_path', 'predecessor_config_auth_path', 'predecessor_failure_stream_path', 'probe_source', 'probe_unsigned_source', 'original_recipe', 'probe_recipe']) if (typeof (field === 'implementation_review_path' ? authority[field] : input[field]) !== 'string') throw new Phase3BProductionError('sealed_path_invalid', `${field} is not sealed`)
