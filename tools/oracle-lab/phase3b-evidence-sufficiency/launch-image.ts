...
function readRecipe(file: string, expectedRecipeSha256: string, kind: Recipe['kind'], sourceSha256: string, preSignSha256: string, sourceTreeSha256: string, toolchainSha256: string, reviewedArtifactSetSha256: string): { recipe: Recipe; identity: StableFileIdentity } {
  ...
  assertExactKeys(value, ['schema_id', 'kind', 'source_sha256', 'source_tree_sha256', 'toolchain_sha256', 'semantics', 'build_command', 'build_command_sha256', 'pre_sign_sha256', 'post_sign_sha256', 'code_signature_identity_sha256', 'reviewed_artifact_set_sha256', 'recipe_sha256'], 'launch_recipe_invalid')
...
export function createSealedLaunchImages(input: Readonly<{ runtime_root: string; original_source: string; probe_source: string; probe_source_sha256: string; probe_unsigned_source: string; probe_unsigned_source_sha256: string; original_recipe: string; original_recipe_sha256: string; probe_recipe: string; probe_recipe_sha256: string; source_tree_sha256: string; toolchain_sha256: string; reviewed_artifact_set_sha256: string }>): Readonly<{ original: LaunchImageRecord; probe: LaunchImageRecord }> {
  ...
  const originalRecipe = readRecipe(input.original_recipe, input.original_recipe_sha256, 'original', originalSource.sha256, originalSource.sha256, input.source_tree_sha256, input.toolchain_sha256, input.reviewed_artifact_set_sha256)
  const probeRecipe = readRecipe(input.probe_recipe, input.probe_recipe_sha256, 'probe', probeSource.sha256, probeUnsignedSource.sha256, input.source_tree_sha256, input.toolchain_sha256, input.reviewed_artifact_set_sha256)
